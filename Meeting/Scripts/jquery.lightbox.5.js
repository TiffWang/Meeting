...
修改属性默认值 
属性有：imageLoading，imageBtnPrev，imageBtnNext，imageBtnClose，imageBlank
作者：阳晓 日期：2013/09/09
...
(function ($) {
    $.fn.lightBox = function (settings) {
        settings = jQuery.extend({
            ...
            imageLoading: '../images/lightboxicoloading.gif', 	// (string) Path and the name of the loading icon
            imageBtnPrev: '../images/lightboxprevlabel.gif', 		// (string) Path and the name of the prev button image
            imageBtnNext: '../images/lightboxnextlabel.gif', 		// (string) Path and the name of the next button image
            imageBtnClose: '../images/lightboxcloselabel.gif', 	// (string) Path and the name of the close btn
            imageBlank: '../images/lightboxblank.gif', 		// (string) Path and the name of a blank image (one pixel)
        ...
        */
        function _resize_container_image_box(intImageWidth, intImageHeight) {
            if ((settings.maxWidth && settings.maxHeight) && (intImageWidth > settings.maxWidth || intImageHeight > settings.maxHeight)) {
